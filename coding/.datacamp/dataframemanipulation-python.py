#ID01 - Dataframe slicing 
#ID02 - map method
#ID03 - 
#ID04 - pandas Dataframe Structure
#ID05 - New index assign
#ID06 - New index name, columns name
#ID07 - Multiindex
#ID08 -
#ID09 - pivoting
#ID10 - stack/ unstack
#ID11 - swap level index
#ID12 - melting data
#ID13 - 
#ID14 - Categorical data/ groupby
#ID18 - zscore
#ID22 - map and bolean Series
#ID23 - value_counts(), sort_values, sum(axis='columns'), drop_duplicates
...
#Dataframes: 2D array with Serries as Columns
...
NY_month1 = sales.loc[slice('NY','1'),:]
...
visitors_pivot = users.pivot('weekday','city','visitors')
...
#ID15 - using 2 dataset in groupby
...
#ID23 - value_counts(), sort_values, sum(axis='columns'), nunique, sort_value, isin(), plot.area(), pd.categorical
